function tomoplan = TCoMX_read_RTplan(filename)
...
% 
% try 
%     % Import the fraction dose 
%     tomoplan.FractionDose = info.FractionGroupSequence.Item_1.ReferencedBeamSequence.Item_1.BeamDose;
% catch
%     % Assing NaN value in order to track the error
%     tomoplan.FractionDose = NaN;
% end
